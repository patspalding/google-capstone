...
# The March-April data are labeled with a "1", and the April-May data are 
# labeled with a "2"
...
# Loop through each ID, and plot each user's weight, daily calories burnt,
# minutes spent sedentary, total minutes spent active, and weighted minutes
# spent active, as well as the trend line for each measurement.
